...
* Built-in icons are sourced from icon8.com, style ios / outline
...
* Online converter like base64encode.org can be used, or for automation there is a Base64 node for NR. Make sure there is no extra information added to the Base64 encoded file.
