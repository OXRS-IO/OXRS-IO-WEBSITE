      ...
      "/add-ons": [
        {
          ...
          children: ["/add-ons/Accessibility/ac-tower-controller.md"],
        },
        {
          text: "Displays",
          link: "/add-ons/displays",
        ...
        // },
        {
          text: "Switches",
          link: "/add-ons/switches",
          children: ["/add-ons/switches/ac-smart-switch.md"],
        },
      ],
      "/docs": [
        {
          ...
          children: [
            ...
            {
              text: "Shields",
              children: ["/docs/hardware/shields/rack32-knx-shield.md"],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          children: [
            ...
            {
              text: "ESP",
              children: ["/docs/libraries/esp-sensor-library.md"],
            },
          ],
        },
        {
          ...
          children: [
            {
              text: "Rack Mount",
              children: ["/docs/cases/rack-mount/rack-mount.md"],
            },
            {
              text: "3D Printed",
              children: ["/docs/cases/3D-printed/README.md"],
            },
          ],
        },
      ],
